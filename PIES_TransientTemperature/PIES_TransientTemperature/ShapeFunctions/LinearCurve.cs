...
{
    public class LinearCurve : IBoundaryShape
    {
        ...
        public LinearCurve(RealPoint v0, RealPoint v1)
        {
            this.V0 = v0;
            this.V1 = v1;
        ...
        private void CalculateParameters()
        {
            ...
            this.a1 = new RealPoint(V1.x - V0.x, V1.y - V0.y);
            this.a2 = new RealPoint(0, 0);
            this.a3 = new RealPoint(0, 0);
        }
        ...
        {
            return new List<RealPoint>() { V0, V1 };
        }
    }
}
